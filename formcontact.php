...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['nom']) && isset($_POST['prenom']) && isset($_POST['email']) && isset($_POST['phone']) && isset($_POST['message'])) {
        ...
        $stmt = $pdo->prepare("INSERT INTO formcontact (nom, prenom, email, phone, message) VALUES (:nom, :prenom, :email, :phone, :message)");
